                ...
                <div className="card mb-lg">
                    ...
                    <div>
                        ...
                        <p className="text-dim" style={{ fontSize: '0.875rem', lineHeight: '1.6', marginBottom: '1rem', paddingLeft: '3rem' }}>
                            Copy this code and paste it inside the <code style={{ backgroundColor: 'var(--bg-dark)', padding: '0.125rem 0.375rem', borderRadius: '4px', color: 'var(--accent-neon)' }}>&lt;head&gt;</code> tag of your index.html file:
                        </p>
