            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '1rem' }}>
                <button
                    ...
                    style={{
                        ...
                        transition: 'all 0.2s',
                        borderRadius: '0',
                        boxShadow: '0 0 20px rgba(16, 124, 16, 0.4)',
                        textTransform: 'uppercase',
                        letterSpacing: '0.05em'
                    }}
                    onMouseOver={(e) => {
                        e.currentTarget.style.boxShadow = '0 0 30px rgba(16, 124, 16, 0.7)';
                        e.currentTarget.style.background = '#15803d';
                        e.currentTarget.style.transform = 'translateY(-1px)';
                    }}
                    onMouseOut={(e) => {
                        e.currentTarget.style.boxShadow = '0 0 20px rgba(16, 124, 16, 0.4)';
                            ...
                            {filteredTokens.map((token, index) => {
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td style={{ maxWidth: '450px', width: '100%' }}>
