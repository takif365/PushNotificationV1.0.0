...
export default function DashboardLayout({ children }) {
    ...
    const links = [
        ...
        { name: 'Broadcast', href: '/dashboard/broadcast', icon: 'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-615M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z' },
        { name: 'Campaigns', href: '/dashboard/campaigns', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
        ...
        <ToastProvider>
            <div className="dashboard-layout">
                ...
                <aside className={`dashboard-sidebar ${isSidebarOpen ? 'open' : ''}`}>
                    ...
                    <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--border-subtle)', display: 'flex', justifyContent: 'center' }}>
                        <div style={{
                            ...
                            <svg style={{ width: '28px', height: '28px', color: '#00FFF0' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            return (
                                <Link
                                    ...
                                    style={{
                                        ...
                                        borderRadius: '0',
                                        color: isActive ? '#00FFF0' : '#9ca3af', // Neon Cyan Active
                                        backgroundColor: isActive ? 'rgba(0, 255, 240, 0.05)' : 'transparent',
                                        border: isActive ? '1px solid #00FFF0' : '1px solid transparent',
                                        boxShadow: isActive ? '0 0 10px rgba(0, 255, 240, 0.2)' : 'none',
                                        textDecoration: 'none',
                                    ...
                                    onMouseOver={(e) => {
                                        if (!isActive) {
                                            ...
                                            e.currentTarget.style.textShadow = '0 0 5px rgba(255, 255, 255, 0.5)';
                                        }
                                    }}
                                    onMouseOut={(e) => {
                                        if (!isActive) {
                ...
                <ConfirmationModal
                    ...
                    message="Are you sure you want to logout? All active connections will be closed."
                    confirmText="LOGOUT"
                    isDestructive={true} // Changed to true to make the button red
                />
            </div>
        </ToastProvider>
    );
